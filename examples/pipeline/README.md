## Pipeline Demo
In this demo, we have three user tasks periodically polling the pipeline for new data from sensors. There are two emulated sensors in this examples with fake data generated by the kernel code.
